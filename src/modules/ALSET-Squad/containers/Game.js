...
class Game extends Component {
  ...
  render() {
    return (
      <div
        id={this.props.type + '-game-' + this.props.index}
        style={{
          height: gameJsonData.gameHeight + 'px',
          width: gameJsonData.gameWidth + 'px',
          float: 'left',
          marginLeft: '5px',
          marginBottom: '15px',
        }}
      >
        ...
        >
          {this.props.type == 'player' ? 'Player ' + (this.props.index + 1) : 'Bot ' + (this.props.index + 1)}
        </h4>
        <Loop>
          <Stage style={this.getWrapperStyles()}>
            ...
            <Collectives
              gameIndex={this.props.index}
              gameType={this.props.type}
              collectivesData={gameJsonData.collectedObjects}
            />
          </Stage>
        </Loop>
      </div>
