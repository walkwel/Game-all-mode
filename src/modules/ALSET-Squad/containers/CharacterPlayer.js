...
class Character extends Component {
  ...
  loop = () => {
    ...
    if (this.props.gamesData.playerScore >= gameJsonData.amountToWin)
      ...
      this.props.updatePlayerSpeed({ gameIndex: this.props.gameIndex, speed: 0 });
    else if (!this.checkBorderCollision()) this.props.updatePlayerSpeed({ gameIndex: this.props.gameIndex, speed: 0 });
    else
      this.props.updatePlayerSpeed({
  ...
  render() {
    if (this.props.playerPositions == null) return <div />;
    switch (this.props.character.type) {
      case 'gnome1':
        return (
          <div id={'player' + this.props.gameIndex}>
            <Gnome1
              characterData={this.props.character}
              positionData={this.props.playerPositions[this.props.gameIndex]}
            />
          </div>
        );
      case 'blonde':
  ...
  return bindActionCreators(
    {
      ...
      generatePlayerCollectives: generatePlayerCollectives,
      removePlayerCollective: removePlayerCollective,
